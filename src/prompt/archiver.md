...
**Output Format:**
A concise summary text that integrates the previous summary (if any) with the new information. Do not just append; synthesize. Do not include introductory or concluding remarks. Just the summary.
</system>
